...
void Stage6Reset(DWORD_PTR, DWORD_PTR);
...
void Stage_06::finalupdate()
{
	Scene::finalupdate();
}

void Stage_06::render(HDC _dc)
{
	Scene::render(_dc);
}
...
void Stage_06::Enter()
{
	...
	m_pMap->init(m_pPlayer, 7, 6, sPlayerIndex, startIndex);
	...
	//item 
	MakeItem(ITEM_TYPE::SCISSORS, startIndex.x + 3, startIndex.y + 2);
	MakeItem(ITEM_TYPE::SCISSORS, startIndex.x + 1, startIndex.y + 4);
	MakeItem(ITEM_TYPE::SCISSORS, startIndex.x + 5, startIndex.y + 4);
	MakeItem(ITEM_TYPE::COTTON, startIndex.x + 5, startIndex.y + 1);
	MakeItem(ITEM_TYPE::COTTON, startIndex.x + 6, startIndex.y + 2);
	MakeItem(ITEM_TYPE::DOLL, startIndex.x , startIndex.y + 2);
	MakeItem(ITEM_TYPE::DOLL, startIndex.x+2, startIndex.y + 1);
	MakeItem(ITEM_TYPE::DOLL, startIndex.x + 4, startIndex.y + 4);
	MakeItem(ITEM_TYPE::DOLL, startIndex.x + 4, startIndex.y + 5);

	//wall
	m_pMap->SetWall(startIndex.x , startIndex.y, POS::DOWN);
	m_pMap->SetWall(startIndex.x+2 , startIndex.y, POS::DOWN);
	m_pMap->SetWall(startIndex.x+5 , startIndex.y, POS::DOWN);
	m_pMap->SetWall(startIndex.x+6 , startIndex.y, POS::DOWN);
	m_pMap->SetWall(startIndex.x+2 , startIndex.y+1, POS::DOWN);
	m_pMap->SetWall(startIndex.x+3 , startIndex.y+1, POS::RIGHT);
	m_pMap->SetWall(startIndex.x+4 , startIndex.y+1, POS::RIGHT);
	m_pMap->SetWall(startIndex.x , startIndex.y+2, POS::RIGHT);
	m_pMap->SetWall(startIndex.x+1 , startIndex.y+2, POS::DOWN);
	m_pMap->SetWall(startIndex.x+2 , startIndex.y+2, POS::DOWN);
	m_pMap->SetWall(startIndex.x+4 , startIndex.y+2, POS::DOWN);
	m_pMap->SetWall(startIndex.x+4 , startIndex.y+2, POS::RIGHT);
	m_pMap->SetWall(startIndex.x+1 , startIndex.y+3, POS::DOWN);
	m_pMap->SetWall(startIndex.x+2 , startIndex.y+3, POS::DOWN);
	m_pMap->SetWall(startIndex.x+1 , startIndex.y+4, POS::DOWN);
	m_pMap->SetWall(startIndex.x+2 , startIndex.y+4, POS::RIGHT);
	m_pMap->SetWall(startIndex.x+4 , startIndex.y+4, POS::DOWN);
	m_pMap->SetWall(startIndex.x+3 , startIndex.y+5, POS::RIGHT);

	//ribbon
	m_pMap->SetRibbon(startIndex.x + 2, startIndex.y + 1, POS::LEFT);
	m_pMap->SetRibbon(startIndex.x, startIndex.y + 2, POS::DOWN);
	m_pMap->SetRibbon(startIndex.x+5, startIndex.y + 3, POS::RIGHT);
	m_pMap->SetRibbon(startIndex.x+4, startIndex.y + 4, POS::RIGHT);
...
void Stage_06::MakeUI() // 추가
{
	...
	pButtonReset->SetClickedCallBack(Stage6Reset, 0, 0);
}
