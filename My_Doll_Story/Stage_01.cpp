...
void Stage1Reset(DWORD_PTR, DWORD_PTR);
...
void Stage_01::Enter()
{
	...
	m_pMap->init(m_pPlayer, 4, 3, sPlayerIndex, startIndex);
...
void Stage_01::MakeUI() // 추가
{
	...
	//Clear
	m_pClearPanel = new ClearPanel(m_SceneType);
	...
	pButtonReset->SetClickedCallBack(Stage1Reset, 0, 0);
}
